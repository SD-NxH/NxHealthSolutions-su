...
import type { MealPreferences, GeneratedPlan, DayMealPlan, Meal, GroceryListItem } from "@/lib/types"
...
export async function generateMealPlanAndList(preferences: MealPreferences): Promise<GeneratedPlan> {
  // If no real API key is provided, use demo mode
  if (!API_KEY || API_KEY === "DEMO_MODE") {
    console.log("Using demo mode - add GEMINI_API_KEY environment variable for real AI-generated meal plans")
