  ...
  return (
    <div className="container mx-auto py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Contact Form */}
        <div className="p-6 rounded-lg shadow-md bg-card border border-border">
          ...
          <form action="https://formsubmit.co/nxhealthsolutions@gmail.com" method="POST">
            ...
            <div className="flex items-center justify-between">
              <Button
                className="bg-brand hover:bg-brand-hover text-brand-foreground font-bold py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-brand"
                type="submit"
              >
                Send Message
              </Button>
        ...
        <div className="p-6 rounded-lg shadow-md bg-card border border-border">
          ...
          <p className="text-muted-foreground mb-2">Feel free to reach out to us with any questions or inquiries.</p>
          <div className="mb-4">
          ...
          <div className="mb-4">
            ...
            <p className="text-muted-foreground">nxhealthsolutions@gmail.com</p>
          </div>
          <div className="mb-4">
            ...
            <Link
              ...
              className="text-muted-foreground hover:text-brand flex items-center"
            >
