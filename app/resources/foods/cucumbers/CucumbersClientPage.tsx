...
import { Droplets, Shield, Heart, Zap, Leaf, Apple } from "lucide-react"
import Link from "next/link"

export default function CucumbersClientPage() {
  return (
      ...
      <div className="bg-white border-b border-green-200">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center gap-2 text-sm text-green-600">
            ...
            <span>→</span>
            <span className="text-green-800 font-medium">Cucumbers</span>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-4">Cucumbers</h1>
              <p className="text-xl text-green-100 max-w-2xl mx-auto">
                Nature's hydration heroes, cucumbers are refreshing vegetables that provide essential nutrients while
                supporting skin health, weight management, and overall wellbeing with their high water content.
              </p>
            </div>
            ...
            <div className="relative h-64 md:h-80 rounded-xl overflow-hidden shadow-2xl mx-auto max-w-2xl">
              <img
                src="/fresh-cucumbers-pile.jpeg"
                alt="Fresh green cucumbers displaying their smooth skin and characteristic elongated shape"
        ...
        <div className="max-w-4xl mx-auto">
          <Tabs defaultValue="overview" className="w-full">
            ...
            <TabsContent value="overview" className="space-y-6">
              <Card className="border-green-200">
                <CardContent className="p-6">
                  <h2 className="text-2xl font-semibold text-green-800 mb-4">About Cucumbers</h2>
                  <div className="prose prose-green max-w-none">
                    <p className="text-gray-700 leading-relaxed">
                      Cucumbers (Cucumis sativus) are cooling, hydrating vegetables that belong to the gourd family.
                      Composed of about 96% water, they're nature's way of providing refreshment while delivering
                      essential nutrients. These crisp vegetables have been cultivated for over 3,000 years and are
                      enjoyed worldwide for their mild flavor and versatile uses.
                    </p>
                    <p className="text-gray-700 leading-relaxed">
            ...
            <TabsContent value="nutrition" className="space-y-6">
              ...
              <Card className="border-green-200">
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold text-green-800 mb-4">Beneficial Compounds</h3>
                  <div className="grid md:grid-cols-3 gap-4">
                    <div className="text-center">
                      <div className="bg-green-100 rounded-full p-3 w-16 h-16 mx-auto mb-2 flex items-center justify-center">
                        <Droplets className="h-8 w-8 text-green-600" />
                      </div>
                      <h4 className="font-semibold text-green-700">Cucurbitacins</h4>
                      <p className="text-sm text-gray-600">Anti-inflammatory compounds</p>
                    </div>
                    <div className="text-center">
                      <div className="bg-green-100 rounded-full p-3 w-16 h-16 mx-auto mb-2 flex items-center justify-center">
                        <Shield className="h-8 w-8 text-green-600" />
                      </div>
                      <h4 className="font-semibold text-green-700">Silica</h4>
                      <p className="text-sm text-gray-600">Supports skin and hair health</p>
                    </div>
                    <div className="text-center">
                      <div className="bg-green-100 rounded-full p-3 w-16 h-16 mx-auto mb-2 flex items-center justify-center">
                        <Zap className="h-8 w-8 text-green-600" />
                      </div>
                      <h4 className="font-semibold text-green-700">Flavonoids</h4>
              ...
              <div className="grid gap-6">
                <Card className="border-green-200">
                  <CardContent className="p-6">
                    ...
                    <p className="text-gray-700">
                      With 96% water content, cucumbers are one of the most hydrating foods available. They help
                      maintain fluid balance, support kidney function, and can contribute significantly to daily
                ...
                <Card className="border-green-200">
                  <CardContent className="p-6">
                    ...
                    <p className="text-gray-700">
                      Cucumbers contain silica, which supports collagen production for healthy skin. Their cooling
                ...
                <Card className="border-green-200">
                  <CardContent className="p-6">
                    ...
                    <p className="text-gray-700">
                      Extremely low in calories but high in water and fiber, cucumbers help create satiety without
                      adding significant calories. They're perfect for healthy snacking and can help reduce overall
                      caloric intake while maintaining hydration and nutrients.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-green-200">
                  <CardContent className="p-6">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h3 className="text-xl font-semibold text-green-800">Anti-inflammatory Properties</h3>
                    </div>
                    <p className="text-gray-700">
                      Cucurbitacins and other compounds in cucumbers have anti-inflammatory effects that may help reduce
                      inflammation markers in the body. This can support overall health and may help with conditions
            ...
            <TabsContent value="preparation" className="space-y-6">
              <Card className="border-green-200">
                <CardContent className="p-6">
                  <h2 className="text-2xl font-semibold text-green-800 mb-4">How to Prepare Cucumbers</h2>
