...
export default function DurianPage() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Header Section */}
      <section className="relative w-full py-16 bg-gradient-to-b from-brand-lighter to-background">
        <div className="container px-4 md:px-6">
          <div className="max-w-3xl mx-auto">
            <Link href="/resources/d" className="inline-flex items-center text-brand hover:text-brand-hover mb-6">
              <ChevronLeft className="h-4 w-4 mr-1" />
              Back to Foods Starting with D
            </Link>
            <h1 className="text-4xl md:text-5xl font-serif font-light tracking-tight text-brand-dark mb-4">Durian</h1>
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-green max-w-none">
              <h2 className="text-2xl font-serif text-brand-dark mb-4">Nutritional Profile</h2>
              ...
              <h2 className="text-2xl font-serif text-brand-dark mb-4">Health Benefits</h2>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div className="bg-brand-lighter p-4 rounded-lg">
                  <h3 className="text-lg font-medium text-brand-dark mb-2">Energy Booster</h3>
                ...
                <div className="bg-brand-lighter p-4 rounded-lg">
                  <h3 className="text-lg font-medium text-brand-dark mb-2">Digestive Health</h3>
                  <p className="text-gray-700">
                ...
                <div className="bg-brand-lighter p-4 rounded-lg">
                  <h3 className="text-lg font-medium text-brand-dark mb-2">Blood Pressure Regulation</h3>
                  <p className="text-gray-700">
                ...
                <div className="bg-brand-lighter p-4 rounded-lg">
                  <h3 className="text-lg font-medium text-brand-dark mb-2">Fertility Support</h3>
                  <p className="text-gray-700">
              ...
              <h2 className="text-2xl font-serif text-brand-dark mb-4">How to Incorporate Durian in Your Diet</h2>
              ...
              <div className="bg-brand-lighter p-6 rounded-lg mb-6">
                <h3 className="text-xl font-medium text-brand-dark mb-2">Did You Know?</h3>
                <p className="text-gray-700">
              ...
              <h2 className="text-2xl font-serif text-brand-dark mb-4">Cautions and Considerations</h2>
              ...
              <h2 className="text-2xl font-serif text-brand-dark mb-4">Selecting and Storing</h2>
            ...
            <div className="mt-12 flex justify-center">
              <Link href="/resources/d">
                <Button variant="outline" className="border-brand text-brand hover:bg-brand-lighter/50 bg-transparent">
