          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div
                ...
                className="group block transform transition-all duration-300 hover:scale-105 hover:-translate-y-1 cursor-pointer"
              >
                <div className="bg-green-100 rounded-xl overflow-hidden shadow-sm transition-all duration-300 hover:shadow-xl h-full border-2 border-green-500">
                  <div className="relative h-40 w-full">
                    <Image
                      src="/personalized-nutrition-plan.png"
                      alt="Premium nutrition services"
                      fill
                      className="object-cover"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-green-800/80 to-green-600/40 flex items-end transition-all duration-300 group-hover:from-green-800/90">
                      <div className="p-4 text-white transform transition-all duration-300 group-hover:translate-y-[-4px]">
                        ...
                        <p className="text-sm text-white/90">Complete meal planning & nutrition tracking</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              >
                <div className="bg-gradient-to-br from-green-100 to-green-200 rounded-xl overflow-hidden shadow-sm transition-all duration-300 hover:shadow-xl h-full border-2 border-green-300">
                  <div className="relative h-40 w-full">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-green-800/80 to-green-600/40 flex items-end transition-all duration-300 group-hover:from-green-800/90">
                      <div className="p-4 text-white transform transition-all duration-300 group-hover:translate-y-[-4px]">
                        <span className="px-2 py-1 bg-blue-500 text-xs font-bold rounded-full mb-2 inline-block">
                          AI POWERED
                        </span>
                        <h3 className="text-xl font-medium mb-1">AI Meal Planner</h3>
                        <p className="text-sm text-white/90">Personalized meal plans generated by AI</p>
                      </div>
                    </div>
                  </div>
                </div>
